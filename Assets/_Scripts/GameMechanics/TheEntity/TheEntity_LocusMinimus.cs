...
namespace TheEntity {
    ...
    public class TheEntity_LocusMinimus : SingletonSuperspectiveObject<TheEntity_LocusMinimus, TheEntity_LocusMinimus.TheEntity_LocusMinimusSave>, AudioJobOnGameObject {
        [SerializeField]
...
#region Saving
        ...
        public override void LoadSave(TheEntity_LocusMinimusSave save) {
        ...
        [Serializable]
        public class TheEntity_LocusMinimusSave : SaveObject<TheEntity_LocusMinimus> {
            public SerializableVector3 particleSystemTransformLocalScale;

            public TheEntity_LocusMinimusSave(TheEntity_LocusMinimus script) : base(script) {
