...
namespace OldPortalMechanics {
	public class OldPortalCameraFollow : MonoBehaviour {
		public bool DEBUG = false;

		public OldPortalContainer portalBeingRendered;
		public bool rotateCamera = false;

		OldPortalTeleporter teleporterForPortalBeingRendered;
		OldPortalTeleporter teleporterForOtherPortal;
