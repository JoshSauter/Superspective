...
namespace OldPillarMechanics {
	public enum VisibilityState_old {
		invisible,
		partiallyVisible,
		visible
	};
	...
	public class PartiallyVisibleObject : MonoBehaviour {
		...
		///////////////////////////////////
		public VisibilityState_old startingVisibilityState;     // invisible, partiallyVisible, or visible
		VisibilityState_old oppositeStartingVisibilityState;
		...
		// Visibility state //
		//////////////////////
		public VisibilityState_old visibilityState { get; private set; }
		...
		#region events
		public delegate void VisibilityStateChangeAction(VisibilityState_old newState);
			...
			switch (direction) {
				case MovementDirection.clockwise:
					if (visibilityState == startingVisibilityState) {
						...
						SetVisibilityState(VisibilityState_old.partiallyVisible);
						return true;
					}
					break;
				case MovementDirection.counterclockwise:
		...
		private void UpdateVisibilitySettings() {
			switch (visibilityState) {
				case VisibilityState_old.invisible:
