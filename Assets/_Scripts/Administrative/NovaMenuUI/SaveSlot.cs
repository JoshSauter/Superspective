...
public class SaveSlot : MonoBehaviour {
    ...
    void InitSaveSlotStateMachine() {
        ...
        saveSlotButtonState.AddTrigger(ButtonState.Hovered, () => {
            RunSaveSlotAnimation(UIStyle.SaveSlot.HoverBgColor, UIStyle.SaveSlot.DefaultTextColor, saveSlotAnimationTime);
        });
        saveSlotButtonState.AddTrigger(ButtonState.ClickHeld, () => {
            RunSaveSlotAnimation(UIStyle.SaveSlot.ClickHeldBgColor, UIStyle.SaveSlot.ClickHeldTextColor, saveSlotAnimationTime);
        });
        saveSlotButtonState.AddTrigger(ButtonState.Clicked, () => {
            RunSaveSlotAnimation(UIStyle.SaveSlot.ClickedBgColor, UIStyle.SaveSlot.ClickedTextColor, saveSlotAnimationTime);
        });
    }
    ...
    void RunDeleteSaveAnimation(DeleteButtonState state, float duration) {
        ...
        switch (state) {
            case DeleteButtonState.Invisible:
                bgEndColor = UIStyle.SaveSlot.Delete.DeleteDefaultBgColor.WithAlpha(0);
                deleteIconEndColor = UIStyle.SaveSlot.Delete.DefaultTextAndIconColor.WithAlpha(0);
                deleteLabelEndColor = UIStyle.SaveSlot.Delete.DefaultTextAndIconColor.WithAlpha(0);
                deleteConfirmEndColor = UIStyle.SaveSlot.Delete.DefaultConfirmColor.WithAlpha(0);
                deleteCancelEndColor = UIStyle.SaveSlot.Delete.DefaultCancelColor.WithAlpha(0);
                break;
            case DeleteButtonState.Idle:
                bgEndColor = UIStyle.SaveSlot.Delete.DeleteDefaultBgColor;
                deleteIconEndColor = UIStyle.SaveSlot.Delete.DefaultTextAndIconColor;
                deleteLabelEndColor = UIStyle.SaveSlot.Delete.DefaultTextAndIconColor;
                deleteConfirmEndColor = UIStyle.SaveSlot.Delete.DefaultConfirmColor.WithAlpha(0);
                deleteCancelEndColor = UIStyle.SaveSlot.Delete.DefaultCancelColor.WithAlpha(0);
                break;
            case DeleteButtonState.Hovered:
                bgEndColor = UIStyle.SaveSlot.Delete.DeleteHoverBgColor;
                deleteIconEndColor = UIStyle.SaveSlot.Delete.DefaultTextAndIconColor;
                deleteLabelEndColor = UIStyle.SaveSlot.Delete.DefaultTextAndIconColor;
                deleteConfirmEndColor = UIStyle.SaveSlot.Delete.DefaultConfirmColor.WithAlpha(0);
                deleteCancelEndColor = UIStyle.SaveSlot.Delete.DefaultCancelColor.WithAlpha(0);
            ...
            case DeleteButtonState.ClickHeld:
                bgEndColor = UIStyle.SaveSlot.Delete.DeleteClickHeldBgColor;
                deleteIconEndColor = UIStyle.SaveSlot.Delete.ClickHeldTextAndIconColor;
                deleteLabelEndColor = UIStyle.SaveSlot.Delete.ClickHeldTextAndIconColor;
                deleteConfirmEndColor = UIStyle.SaveSlot.Delete.DefaultConfirmColor.WithAlpha(0);
                deleteCancelEndColor = UIStyle.SaveSlot.Delete.DefaultCancelColor.WithAlpha(0);
                break;
            case DeleteButtonState.DeleteConfirmation:
                ...
                bgEndColor = UIStyle.SaveSlot.Delete.DeleteClickedBgColor;
                deleteIconEndColor = UIStyle.SaveSlot.Delete.ClickedTextAndIconColor;
                deleteLabelEndColor = UIStyle.SaveSlot.Delete.ClickedTextAndIconColor.WithAlpha(0);
                deleteConfirmEndColor = UIStyle.SaveSlot.Delete.DefaultConfirmColor;
                deleteCancelEndColor = UIStyle.SaveSlot.Delete.DefaultCancelColor;
                break;
            default:
    ...
    void RunDeleteConfirmAnimation(ButtonState confirmButtonState, float duration) {
        ...
        switch (confirmButtonState) {
            ...
            case ButtonState.Clicked:
                deleteConfirmEndColor = UIStyle.SaveSlot.Delete.ClickHeldConfirmColor;
                break;
            default:
    ...
    void RunDeleteCancelAnimation(ButtonState cancelButtonState, float duration) {
        ...
        switch (cancelButtonState) {
            ...
            case ButtonState.ClickHeld:
            case ButtonState.Clicked:
                deleteCancelEndColor = UIStyle.SaveSlot.Delete.ClickHeldCancelColor;
                break;
            default:
    ...
    public void ResetSaveSlot() {
        RunSaveSlotAnimation(UIStyle.SaveSlot.DefaultBgColor, UIStyle.SaveSlot.DefaultTextColor, saveSlotUnhoverAnimationTime);
