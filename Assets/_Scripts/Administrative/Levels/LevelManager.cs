...
namespace LevelManagement {
	...
	public enum Levels {
		...
		LocusMinimus = 28,
		LocusMinimusBetweenWorlds = 30,
		LocusMinimusDarkSide = 31,
		TransitionWhiteRoom3GrowShrinkIntro = 32, // Deprecated, maybe re-use architecture?
		LocusMaximus = 34,
		LocusMaximusExit = 40,
		Ascension0 = 35,
		Ascension1 = 36,
...
#region PlayerDefaultLocations
		...
		public static readonly TwoWayDictionary<Levels, string> enumToSceneName = new TwoWayDictionary<Levels, string>() {
			...
			{ Levels.LocusMinimus, "_LocusMinimus" },
			{ Levels.LocusMinimusBetweenWorlds, "_LocusMinimusBetweenWorlds" },
			{ Levels.LocusMinimusDarkSide, "_LocusMinimusDarkSide" },
			{ Levels.TransitionWhiteRoom3GrowShrinkIntro, "_TransitionWhiteRoom3GrowShrinkIntro" },
			{ Levels.LocusMaximus, "_LocusMaximus" },
			{ Levels.LocusMaximusExit, "_LocusMaximusExit" },
