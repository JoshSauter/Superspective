...
Shader "TextMeshPro/Distance Field_InverseDimensionObject" {
	...
	Properties{
		...
		SubShader{
			...
			Pass {
				...
				#include "TMPro.cginc"
				#include "Assets/Resources/Shaders/DimensionShaders/DimensionShaderHelpers.cginc"
				...
				{
					float2 viewportVertex = float2(input.position.x / _ResolutionX, input.position.y / _ResolutionY);
