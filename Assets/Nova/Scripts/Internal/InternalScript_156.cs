        ...
        public Mesh InternalProperty_291
        {
            ...
            get
            {
                if (InternalField_844 == null)
                {
                    ...
                    InternalField_844.SetVertexBufferData((NativeArray<InternalType_388>)InternalField_839, 0, 0, InternalField_839.Length);

                    InternalField_844.SetIndices((NativeArray<ushort>)InternalField_840, MeshTopology.Triangles, 0);
                }
