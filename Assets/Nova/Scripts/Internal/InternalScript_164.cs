...
namespace Nova.InternalNamespace_0.InternalNamespace_10
{
    internal static partial class InternalType_362
    {
        ...
        internal struct InternalType_295 : InternalType_147
        {
            ...
            [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
            public NativeHashMap<InternalType_131, InternalType_101> InternalField_966;
            [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
            ...
            [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
            private NativeHashMap<InternalType_131, InternalType_162<InternalType_304, InternalType_297>> InternalField_962;
            ...
            [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
            private NativeHashMap<InternalType_19, byte> InternalField_956;
            [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
            private NativeHashMap<InternalType_19, byte> InternalField_955;
            [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
            ...
            private void InternalMethod_1323()
            {
                for (int InternalVar_1 = 0; InternalVar_1 < InternalField_968.Length; ++InternalVar_1)
                {
                    ...
                    InternalType_162<InternalType_305, InternalType_361> InternalVar_4 = InternalField_963.InternalMethod_1007(InternalVar_2, InternalVar_3.InternalProperty_304);
                    ...
                    for (int InternalVar_7 = 0; InternalVar_7 < InternalVar_3.InternalField_992.InternalProperty_216; ++InternalVar_7)
                    {
                        ...
                        if (!InternalVar_9.InternalField_902.InternalMethod_1605())
                        {
                            ...
                            {
                                InternalField_1259 = InternalVar_8.InternalField_985.InternalMethod_1364(),
                                InternalField_1258 = false
                            };
                            continue;
                        }

                        ref InternalType_297 InternalVar_11 = ref InternalVar_5.InternalMethod_758(InternalVar_8.InternalField_988);

                        if (!InternalVar_11.InternalField_1179.InternalProperty_779)
                        {
                            InternalVar_10 = InternalType_361.InternalField_1256;
                            continue;
                        }

                        float3 InternalVar_12 = InternalType_178.InternalField_477 * InternalVar_11.InternalField_1178.InternalField_945;
                        float3 InternalVar_13 = InternalVar_8.InternalField_989 * InternalVar_12 + InternalVar_11.InternalField_1178.InternalField_946;

                        if (!InternalType_187.InternalMethod_935(ref InternalVar_13))
                        {
                            Debug.LogError($"BoundCenter for drawcall was invalid: {InternalVar_13}");
                        }

                        InternalVar_10 = new InternalType_361()
                        {
                            InternalField_1259 = new Bounds(InternalVar_13, InternalVar_6.InternalMethod_758((int)InternalVar_8.InternalField_988).InternalField_1245),
                            InternalField_1258 = InternalVar_11.InternalField_1176
                        };
                    }
            ...
            private void InternalMethod_1322()
            {
                ...
                InternalField_957.AddRange(InternalField_959);

                while (InternalField_957.Length != 0)
                {
                    InternalType_19 InternalVar_1 = InternalField_957.InternalMethod_1018();
                    ref InternalType_297 InternalVar_2 = ref InternalField_962.InternalMethod_1297(ref InternalVar_1);
                    ...
                    if (InternalVar_4)
                    {
                        for (int InternalVar_5 = 0; InternalVar_5 < InternalVar_3.InternalProperty_216; ++InternalVar_5)
                        {
                            ...
                            ref InternalType_297 InternalVar_7 = ref InternalField_962.InternalMethod_1297(ref InternalVar_6);
                            int InternalVar_8 = InternalField_965.InternalMethod_1297(ref InternalVar_6).InternalField_1246;
            ...
            private void InternalMethod_1321()
            {
                ...
                for (int InternalVar_1 = 0; InternalVar_1 < InternalField_954.Length; ++InternalVar_1)
                {
                    ...
                    if (InternalField_965.InternalMethod_1297(ref InternalVar_2).InternalField_1246 == 0)
                    {
                        continue;
                    }

                    ref InternalType_297 InternalVar_3 = ref InternalField_962.InternalMethod_1297(ref InternalVar_2);
                    ...
                    for (int InternalVar_5 = InternalVar_1 + 1; InternalVar_5 < InternalField_954.Length; ++InternalVar_5)
                    {
                        ...
                        if (InternalField_965.InternalMethod_1297(ref InternalVar_6).InternalField_1246 == 0)
                        {
                            continue;
                        }
            ...
            private static void InternalMethod_1315(ref InternalType_292 InternalParameter_1390, ref InternalType_292 InternalParameter_1389, out bool InternalParameter_1388, out bool InternalParameter_1387)
            {
                ...
                {
                    InternalParameter_1388 = true;
                    InternalMethod_1314(ref InternalVar_2, ref InternalParameter_1389, ref InternalVar_1, out float InternalVar_7, out float InternalVar_8);
                    InternalParameter_1387 = InternalVar_8 < InternalVar_7;
                    return;
                }
                else if (InternalVar_6.InternalProperty_301)
                {
                    InternalParameter_1388 = true;
                ...
                {
                    float3 InternalVar_7 = float3.zero;
                    ref float3 InternalVar_8 = ref InternalParameter_1390.InternalField_947[0];
                    ref float3 InternalVar_9 = ref InternalParameter_1390.InternalField_947[2];
                    float3 InternalVar_10 = default;
                    float3 InternalVar_11 = default;

                    if (InternalType_187.InternalMethod_910(ref InternalVar_8, ref InternalVar_9, ref InternalVar_1[0], ref InternalVar_1[2], out InternalVar_10) &&
                        InternalParameter_1389.InternalField_948.InternalMethod_1316(ref InternalVar_7, ref InternalVar_10, out InternalVar_11))
                    {
                        InternalParameter_1388 = true;
                        InternalParameter_1387 = InternalVar_10.InternalMethod_942(ref InternalVar_11);
                        return;
                    }

                    if (InternalType_187.InternalMethod_910(ref InternalVar_8, ref InternalVar_9, ref InternalVar_1[1], ref InternalVar_1[3], out InternalVar_10) &&
                        InternalParameter_1389.InternalField_948.InternalMethod_1316(ref InternalVar_7, ref InternalVar_10, out InternalVar_11))
                    {
                        InternalParameter_1388 = true;
                        InternalParameter_1387 = InternalVar_10.InternalMethod_942(ref InternalVar_11);
                    ...
                    ref float3 InternalVar_12 = ref InternalParameter_1390.InternalField_947[1];
                    ref float3 InternalVar_13 = ref InternalParameter_1390.InternalField_947[3];
                    if (InternalType_187.InternalMethod_910(ref InternalVar_12, ref InternalVar_13, ref InternalVar_1[0], ref InternalVar_1[2], out InternalVar_10) &&
                        InternalParameter_1389.InternalField_948.InternalMethod_1316(ref InternalVar_7, ref InternalVar_10, out InternalVar_11))
                    {
                        InternalParameter_1388 = true;
                        InternalParameter_1387 = InternalVar_10.InternalMethod_942(ref InternalVar_11);
                    ...
                    if (InternalType_187.InternalMethod_910(ref InternalVar_12, ref InternalVar_13, ref InternalVar_1[1], ref InternalVar_1[3], out InternalVar_10) &&
                        InternalParameter_1389.InternalField_948.InternalMethod_1316(ref InternalVar_7, ref InternalVar_10, out InternalVar_11))
                    {
                        InternalParameter_1388 = true;
                        InternalParameter_1387 = InternalVar_10.InternalMethod_942(ref InternalVar_11);
            ...
            private void InternalMethod_1311(InternalType_131 InternalParameter_1379)
            {
                ...
                InternalType_162<InternalType_304, InternalType_297> InternalVar_2 = InternalField_962.InternalMethod_1007(InternalParameter_1379, InternalVar_1.InternalProperty_216);
                ...
                for (int InternalVar_4 = 0; InternalVar_4 < InternalVar_1.InternalProperty_216; ++InternalVar_4)
                {
                    ...
                    float4x4 InternalVar_6 = math.mul(InternalField_1132.InternalField_1255, InternalVar_5.InternalField_1243);
                    float4x4 InternalVar_7 = math.mul(InternalVar_6, InternalVar_5.InternalField_1244.InternalMethod_1368());
                    float4 InternalVar_8 = InternalVar_7.InternalMethod_897(2);

                    ref InternalType_297 InternalVar_9 = ref InternalVar_2.InternalMethod_758(InternalVar_4);
                    if (math.all(InternalVar_8 < float4.zero))
                    {
                        InternalVar_9.InternalField_1179 = InternalType_296.InternalField_1171;
                        continue;
                    }

                    InternalType_293 InternalVar_10 = InternalType_293.InternalMethod_1319(ref InternalVar_6);

                    InternalVar_9.InternalField_1177 = new InternalType_292(ref InternalVar_7, ref InternalVar_10);

                    float3 InternalVar_11 = InternalType_187.InternalMethod_944(ref InternalVar_5.InternalField_1242, ref InternalField_1132.InternalField_1254, float3.zero);
                    InternalVar_9.InternalField_1176 = InternalVar_11.z > 0f;

                    InternalVar_9.InternalField_1179 = InternalField_1132.InternalMethod_1548(ref InternalVar_9.InternalField_1177);
                }
            ...
            {
                [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
                public NativeHashMap<InternalType_131, InternalType_162<InternalType_304, InternalType_297>> InternalField_953;

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public int Compare(InternalType_19 x, InternalType_19 y)
                {
                    ref InternalType_296 InternalVar_1 = ref InternalField_953.InternalMethod_1297(ref x).InternalField_1179;
                    ref InternalType_296 InternalVar_2 = ref InternalField_953.InternalMethod_1297(ref y).InternalField_1179;
            ...
            {
                if (InternalField_963.InternalMethod_1010(InternalParameter_1373, out InternalType_162<InternalType_305, InternalType_361> InternalVar_1))
                {
                    InternalField_961.InternalMethod_1027(ref InternalVar_1);
                }

                if (InternalField_962.InternalMethod_1010(InternalParameter_1373, out InternalType_162<InternalType_304, InternalType_297> InternalVar_2))
                {
            ...
            public void InternalMethod_702()
            {
                ...
                InternalField_956.InternalMethod_1009();
                InternalField_955.InternalMethod_1009();
