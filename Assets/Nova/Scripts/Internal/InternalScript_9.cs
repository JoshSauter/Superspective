...
{
    internal class InternalType_153<T> : ICollection<T>
    {
        [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
        private List<T> InternalField_444 = null;
        [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
        private Dictionary<T, int> InternalField_445 = null;

        [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
        public InternalType_521<T> InternalProperty_221 => InternalField_444.InternalMethod_2043();

        [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
        public int Count => InternalField_444.Count;

        [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
        public bool IsReadOnly => ((ICollection<T>)InternalField_444).IsReadOnly;

        public T this[int InternalParameter_559] => InternalField_444[InternalParameter_559];
        ...
        public void InternalMethod_719(List<T> InternalParameter_560)
        {
        ...
        public void InternalMethod_720(InternalType_153<T> InternalParameter_561)
        {
            InternalMethod_719(InternalParameter_561.InternalField_444);
        }

        public void InternalMethod_721(T[] InternalParameter_562)
        {
        ...
        {
            T InternalVar_1 = InternalField_444[InternalParameter_563];
        ...
        public int InternalMethod_723(T InternalParameter_564)
        {
        ...
        public InternalType_153(IEqualityComparer<T> InternalParameter_565)
        {
            InternalField_445 = new Dictionary<T, int>(InternalParameter_565);
            InternalField_444 = new List<T>();
        }

        public InternalType_153(int InternalParameter_566 = 4)
        {
            InternalField_445 = new Dictionary<T, int>(InternalParameter_566);
            InternalField_444 = new List<T>(InternalParameter_566);
        }
