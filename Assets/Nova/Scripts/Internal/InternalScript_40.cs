    ...
    internal class InternalType_64 : InternalType_136<InternalType_64>
    {
        ...
        private bool InternalMethod_429(ref PlayerLoopSystem InternalParameter_315)
        {
            ...
            for (int InternalVar_1 = 0; InternalVar_1 < InternalParameter_315.subSystemList.Length; ++InternalVar_1)
            {
                ...
                PlayerLoopSystem[] InternalVar_3 = new PlayerLoopSystem[InternalVar_2.Length + 2];
                ...
                {
                    if (InternalVar_2[InternalVar_4].type != typeof(UnityEngine.PlayerLoop.PostLateUpdate.PlayerUpdateCanvases))
                    {
                        continue;
                    }

                    Array.Copy(InternalVar_2, sourceIndex: 0, InternalVar_3, destinationIndex: 1, InternalVar_4 + 1);

                    InternalVar_3[InternalVar_4 + 2] = new PlayerLoopSystem()
                    {
                        type = typeof(NovaEngine),
                        updateDelegate = InternalMethod_431
                    };

                    if (InternalVar_4 + 1 < InternalVar_2.Length)
                    {
                        Array.Copy(InternalVar_2, sourceIndex: InternalVar_4 + 1, InternalVar_3, destinationIndex: InternalVar_4 + 3, InternalVar_2.Length - InternalVar_4 - 1);
                    }
                ...
                InternalVar_3[InternalVar_3.Length - 1] = new PlayerLoopSystem()
                {
                    type = typeof(NovaEngine),
                    updateDelegate = InternalMethod_431
                };
        ...
        private bool InternalMethod_430(ref PlayerLoopSystem InternalParameter_316)
        {
            ...
            for (int InternalVar_1 = 0; InternalVar_1 < InternalParameter_316.subSystemList.Length; ++InternalVar_1)
            {
                ...
                for (int InternalVar_5 = 0; InternalVar_5 < InternalVar_2.Length; ++InternalVar_5)
                {
                    ...
                    bool InternalVar_7 = InternalVar_6.type == typeof(NovaEngine);
                    bool InternalVar_8 = InternalVar_6.type == typeof(NovaEngine.NovaAnimator);

                    if (!InternalVar_7 && !InternalVar_8)
                    {
