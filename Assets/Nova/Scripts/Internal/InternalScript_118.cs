...
namespace Nova.InternalNamespace_0
{
    ...
    internal class InternalType_87<T5> where T5 : struct, System.IEquatable<T5>, InternalType_84
    {
        ...
        public InternalType_77 InternalMethod_498<T>(uint InternalParameter_362, InternalType_76<T> InternalParameter_363, out InternalType_5 InternalParameter_364) where T : unmanaged, System.IEquatable<T>
        {
            ...
            for (int InternalVar_6 = InternalVar_1.Count - 1; InternalVar_6 >= 0; --InternalVar_6)
            {
                ...
                InternalType_521<InternalType_75> InternalVar_8 = InternalVar_7.InternalProperty_34.InternalProperty_164;

                bool InternalVar_9 = false;
                InternalType_77 InternalVar_10 = InternalType_77.InternalField_251;

                for (int InternalVar_11 = 0; InternalVar_11 < InternalVar_8.InternalProperty_433; ++InternalVar_11)
                {
                    InternalType_77 InternalVar_12 = InternalVar_8[InternalVar_11].InternalMethod_3340(InternalVar_2.InternalField_290, InternalVar_3, InternalParameter_363, InternalVar_5);

                    if (InternalVar_12.InternalMethod_490())
                    {
                        InternalVar_9 = true;

                        InternalVar_4 = InternalMethod_499(InternalVar_4, InternalVar_12);
                        InternalVar_10 = InternalMethod_499(InternalVar_10, InternalVar_12);
                    }
                }
    ...
    internal class InternalType_90<T6> where T6 : struct, System.IEquatable<T6>, InternalType_84
    {
        public class InternalType_91 : InternalNamespace_0.InternalType_89
        {
            ...
            public void InternalMethod_2056<T>(InternalType_78 InternalParameter_2695, T InternalParameter_2694, InternalType_521<T6> InternalParameter_2693, InternalType_85 InternalParameter_2692, bool InternalParameter_2376) where T : unmanaged, System.IEquatable<T>
            {
                ...
                InternalType_5 InternalVar_5 = InternalVar_4.InternalProperty_738.InternalProperty_169;
                bool InternalVar_6 = InternalVar_5 != null;

                InternalType_93 InternalVar_7 = InternalField_297[InternalVar_2];
                bool InternalVar_8 = InternalVar_4.InternalField_300;

                InternalType_169<InternalType_94>.InternalMethod_821(InternalVar_7.InternalField_301);

                bool InternalVar_9 = !InternalParameter_2694.Equals(default(T));

                if (InternalField_294.IsSet(InternalVar_2))
                {
                    if (InternalVar_9 && InternalParameter_2692 != InternalType_85.InternalField_284)
                    {
                        return;
                    }
                ...
                if (InternalVar_8 != InternalVar_9)
                {
                ...
                InternalType_77 InternalVar_10 = InternalField_298.InternalMethod_497(InternalVar_1);

                InternalType_76<T>? InternalVar_11 = InternalVar_6 ? InternalVar_5.InternalProperty_34.InternalMethod_464<T>(InternalVar_1) : null;

                if (InternalParameter_2692 == InternalType_85.InternalField_285 && InternalVar_9)
                {
                    InternalType_76<T> InternalVar_12 = new InternalType_76<T>() { InternalField_246 = true, InternalField_247 = InternalParameter_2694, InternalField_248 = InternalVar_3.InternalProperty_170, InternalField_250 = InternalParameter_2376 };

                    if (!InternalVar_8)
                    {
                        InternalField_298.InternalMethod_2057(InternalParameter_2695, InternalVar_12, InternalParameter_2693);
                    }

                    InternalType_77 InternalVar_14 = InternalField_298.InternalMethod_498(InternalVar_1, InternalVar_12, out InternalType_5 InternalVar_13);

                    if (InternalVar_14.InternalMethod_491())
                    {
                        if (!InternalVar_10.InternalMethod_490())
                        {
                            InternalVar_10 = InternalVar_14;
                        }
                        else if (InternalVar_6 && InternalVar_13 != InternalVar_5)
                        {
                            InternalVar_5.InternalProperty_34.InternalMethod_467(InternalParameter_2695);

                            InternalVar_5 = InternalVar_13;

                            InternalVar_6 = true;
                        }

                        InternalVar_3.InternalProperty_169 = InternalVar_13;
                    }
                }

                bool InternalVar_15 = true;


                bool InternalVar_16 = false;

                if (InternalVar_6 && InternalVar_5 != InternalVar_3.InternalProperty_169 && InternalVar_11.HasValue)
                {
                    for (int InternalVar_17 = 0; InternalVar_17 < InternalParameter_2693.InternalProperty_433; ++InternalVar_17)
                    {
                        if (InternalParameter_2693[InternalVar_17].InternalProperty_169 == InternalVar_5)
                        {
                            InternalVar_16 = true;
                            break;
                        }
                    ...
                    if (InternalVar_8 && InternalParameter_2692 != InternalType_85.InternalField_284)
                    {
                        InternalVar_3.InternalProperty_169 = InternalVar_5;
                        InternalVar_15 = InternalVar_16;
                    }
                    else if (!InternalVar_16 || !InternalVar_9)
                    {
                        InternalVar_5.InternalProperty_34.InternalMethod_466<T>(InternalParameter_2695, new InternalType_76<T>() { InternalField_246 = false, InternalField_247 = default, InternalField_248 = InternalVar_3.InternalProperty_170, InternalField_250 = InternalParameter_2376 });
                    }
                    else if (InternalVar_9 && InternalVar_3.InternalProperty_169 != null)
                    {
                        InternalVar_5.InternalProperty_34.InternalMethod_467(InternalParameter_2695);
                    }
                }

                bool InternalVar_18 = InternalVar_3.InternalProperty_169 != null;

                if (InternalVar_18)
                {
                    Vector3 InternalVar_19 = InternalVar_3.InternalProperty_170;

                    if (InternalField_293.Value == 0)
                    {
                        InternalVar_3.InternalProperty_169.InternalProperty_34.InternalMethod_466<T>(InternalParameter_2695, new InternalType_76<T>() { InternalField_246 = true, InternalField_247 = default, InternalField_248 = InternalVar_19, InternalField_250 = InternalParameter_2376 });
                    }

                    InternalVar_3.InternalProperty_169.InternalProperty_34.InternalMethod_466<T>(InternalParameter_2695, new InternalType_76<T>() { InternalField_246 = InternalVar_15, InternalField_247 = InternalParameter_2694, InternalField_248 = InternalVar_19, InternalField_249 = InternalVar_10, InternalField_250 = InternalParameter_2376 });
                    ...
                    {
                        InternalVar_18 = false;
                        InternalVar_3.InternalProperty_169 = null;
                        InternalField_298.InternalMethod_496(InternalParameter_2695.InternalField_257);
                        InternalField_294.SetBits(InternalVar_2, InternalVar_9);
                    }
                }
                else if (InternalVar_9)
                {
                    InternalField_294.SetBits(InternalVar_2, true);
                }

                InternalField_293.SetBits(InternalVar_2, InternalVar_18);

                InternalField_295[InternalVar_1] = new InternalType_92() { InternalProperty_738 = InternalVar_3, InternalField_300 = InternalVar_9 };
    ...
    internal readonly struct InternalType_95<T7> : System.IEquatable<InternalType_95<T7>> where T7 : struct, System.IEquatable<T7>
    {
        [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
        public readonly T7 InternalField_303;

        public bool Equals(InternalType_95<T7> other) => InternalField_303.Equals(default) && other.InternalField_303.Equals(default) ? true : false;

        public InternalType_95(ref T7 InternalParameter_378)
        {
            InternalField_303 = InternalParameter_378;
        }
    }
}
