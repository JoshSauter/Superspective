            ...
            public static void InternalMethod_1137(ref InternalType_228.InternalType_229 InternalParameter_1220, ref NativeList<InternalType_131> InternalParameter_1221, ref NativeList<InternalType_133> InternalParameter_1222)
            {
                ...
                for (int InternalVar_2 = 0; InternalVar_2 < InternalVar_1; ++InternalVar_2)
                {
                    ...
                    for (int InternalVar_5 = 0; InternalVar_5 < InternalVar_1; ++InternalVar_5)
                    {
                        ...
                        if (InternalParameter_1220.InternalMethod_1133(InternalVar_3, InternalParameter_1221[InternalVar_5]))
                        {
                            InternalVar_4 = true;
                            break;
                        }
                    ...
                    unsafe
                    {
                        for (int InternalVar_5 = InternalParameter_1222.Length - 1; InternalVar_5 < InternalParameter_1222.Length; ++InternalVar_5)
                        {
                            ...
                            if (InternalVar_6.InternalProperty_216 > 0)
                            {
                                InternalParameter_1222.AddRange(InternalVar_6.InternalProperty_232, InternalVar_6.InternalProperty_216);
                            }
                        }
                    }
                }
