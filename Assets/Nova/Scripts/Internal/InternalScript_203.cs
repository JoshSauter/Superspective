...
namespace Nova.InternalNamespace_0.InternalNamespace_10
{
    ...
    {
        public static bool InternalMethod_1604(int InternalParameter_1735, ref NativeList<InternalType_131> InternalParameter_1736, ref NativeHashMap<InternalType_131, InternalType_162<InternalType_288, InternalType_373>> InternalParameter_1737, out InternalType_131 InternalParameter_1738, out int InternalParameter_1739)
        {
            for (int InternalVar_1 = 0; InternalVar_1 < InternalParameter_1736.Length; ++InternalVar_1)
            {
                InternalParameter_1738 = InternalParameter_1736[InternalVar_1];
                InternalType_162<InternalType_288, InternalType_373> InternalVar_2 = InternalParameter_1737[InternalParameter_1738];
                if (InternalParameter_1735 >= InternalVar_2.InternalProperty_216)
                {
                    InternalParameter_1735 -= InternalVar_2.InternalProperty_216;
                    continue;
                }

                InternalParameter_1739 = InternalParameter_1735;
                return true;
            }

            InternalParameter_1738 = InternalType_131.InternalField_415;
            InternalParameter_1739 = -1;
            return false;
        }
