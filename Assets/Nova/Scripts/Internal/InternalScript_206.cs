...
namespace Nova.InternalNamespace_0.InternalNamespace_10
{
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool InternalMethod_1600(this ref NativeList<InternalType_131> InternalParameter_1727, ref NativeHashMap<InternalType_131, InternalType_380> InternalParameter_1728, ref int InternalParameter_1729, out InternalType_379 InternalParameter_1730, out InternalType_131 InternalParameter_1731)
        {
            for (int InternalVar_1 = 0; InternalVar_1 < InternalParameter_1727.Length; ++InternalVar_1)
            {
                InternalParameter_1731 = InternalParameter_1727[InternalVar_1];
                InternalType_380 InternalVar_2 = InternalParameter_1728[InternalParameter_1731];

                if (InternalParameter_1729 >= InternalVar_2.InternalProperty_335)
                {
                    InternalParameter_1729 -= InternalVar_2.InternalProperty_335;
                    continue;
                }

                for (int InternalVar_3 = 0; InternalVar_3 < InternalVar_2.InternalProperty_334; ++InternalVar_3)
                {
                    InternalParameter_1730 = InternalVar_2.InternalField_1316.InternalMethod_758(InternalVar_3);
                    if (InternalParameter_1729 >= InternalParameter_1730.InternalField_1314.InternalProperty_216)
                    {
                        InternalParameter_1729 -= InternalParameter_1730.InternalField_1314.InternalProperty_216;
                        continue;
                    }
            ...
            InternalParameter_1730 = default;
            InternalParameter_1731 = default;
            return false;
        }
    }
}
