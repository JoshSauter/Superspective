...
namespace Nova.InternalNamespace_0.InternalNamespace_2
{
    ...
    internal struct InternalType_139 : IDisposable
    {
        ...
        [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
        private NativeHashMap<InternalType_131, InternalType_133> InternalField_425;
        ...
        public static InternalType_139 InternalMethod_674()
        {
            return new InternalType_139()
            {
                ...
                InternalField_425 = new NativeHashMap<InternalType_131, InternalType_133>(InternalType_178.InternalField_3013, Allocator.Persistent)
            };
        }
    }
}
