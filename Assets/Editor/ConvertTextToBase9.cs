...
public class ConvertTextToBase9 : ScriptableWizard {
    static readonly Dictionary<int, char> valueToBase9Char = new Dictionary<int, char> {
        {0, '0'},
        {1, '1'},
        {2, '2'},
        {3, '3'},
        ...
        foreach (GameObject go in Selection.gameObjects) {
            ...
            try {
                ...
                for (int i = 0; i < splitText.Length; i++) {
                    ...
                    if (int.TryParse(piece, out int value)) splitText[i] = valueToBase9Char[value].ToString();
                }
