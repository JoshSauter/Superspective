...
namespace UnityEditor {
    internal class StandardShaderGUIEpitaph : ShaderGUI {
        ...
        void DoSpecularMetallicArea() {
            ...
            m_MaterialEditor.ShaderProperty(
                showSmoothnessScale ? smoothnessScale : smoothness,
                showSmoothnessScale ? Styles.smoothnessScaleText : Styles.smoothnessText,
                indentation
            );
        ...
        static class Styles {
            ...
            public static readonly GUIContent albedoText = EditorGUIUtility.TrTextContent(
                "Albedo",
            ...
            public static readonly GUIContent highlightsText =
            ...
            public static readonly GUIContent
                normalMapText = EditorGUIUtility.TrTextContent("Normal Map", "Normal Map");

            public static readonly GUIContent heightMapText =
                EditorGUIUtility.TrTextContent("Height Map", "Height Map (G)");

            public static readonly GUIContent occlusionText =
            ...
            public static readonly GUIContent detailMaskText =
                EditorGUIUtility.TrTextContent("Detail Mask", "Mask for Secondary Maps (A)");

            public static readonly GUIContent detailAlbedoText =
                EditorGUIUtility.TrTextContent("Detail Albedo x2", "Albedo (RGB) multiplied by 2");

            public static readonly GUIContent detailNormalMapText =
