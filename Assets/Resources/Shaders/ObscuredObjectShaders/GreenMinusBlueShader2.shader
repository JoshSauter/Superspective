Shader "Custom/ObscuredObjectShaders/GreenMinusBlueShader2"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "Queue"="Geometry" "RenderType"="GreenMinusBlue2" }
		LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				clip(_BiasTowardsVisible + samplePixel.g - samplePixel.b);
				// apply fog
