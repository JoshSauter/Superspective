Shader "Custom/ObscuredObjectShaders/BlueMinusRedShader2"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "Queue"="Geometry" "RenderType"="BlueMinusRed2" }
		LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				clip(_BiasTowardsVisible + samplePixel.b - samplePixel.r);
				// apply fog
