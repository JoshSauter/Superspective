Shader "Custom/ObscuredObjectShaders/RedMinusGreenShader1"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "Queue"="Geometry" "RenderType"="RedMinusGreen1" }
		LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				clip(_BiasTowardsVisible + samplePixel.r - samplePixel.g);
				// apply fog
