...
Shader "Custom/DimensionShaders/DimensionObjectSpecular"
{
	Properties
	{
...
#define UNITY_SETUP_BRDF_INPUT SpecularSetup
			...
			SubShader
		{
			Tags { "RenderType"="DimensionObject" "PerformanceChecks" = "False" }
			LOD 300
			...
			half4 fragBaseNew(VertexOutputForwardBase i) : SV_TARGET {
				ClipDimensionObject(i.pos, _Dimension, _Channel, _Inverse);
				return fragBase(i);
			}
